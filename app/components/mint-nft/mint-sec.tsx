    ...
    <div className="w-[800px] h-[500px] mx-auto p-4">
      <div className="flex flex-col items-center justify-center gap-4 h-full text-white rounded-lg p-8 shadow-lg">
        ...
        <p className="text-gray-400 text-sm text-center leading-6">
          ...
          project. You&#39;ll also get a share of the success. Learn more about
          the exclusive features by visiting the link in the description.
        </p>
        ...
        <div className="flex items-center gap-4 text-center justify-center">
          ...
          <div className="flex items-center flex-col gap-4">
            <p className="text-lg font-semibold">Minting one person account</p>
            <Link href="/mintfq" className="bg-[#222] p-2 rounded-lg hover:bg-[#444]">Learn More</Link>
          </div>
        </div>
